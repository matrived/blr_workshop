...
class QwenImageTrainingModule(DiffusionTrainingModule):
    def __init__(
        ...
        tokenizer_config = ModelConfig(model_id="Qwen/Qwen-Image", local_model_path=model_path, skip_download=True, origin_file_pattern="tokenizer/") if tokenizer_path is None else ModelConfig(tokenizer_path)
        processor_config = ModelConfig(model_id="Qwen/Qwen-Image-Edit", local_model_path=model_path, skip_download=True,origin_file_pattern="processor/") if processor_path is None else ModelConfig(processor_path)
